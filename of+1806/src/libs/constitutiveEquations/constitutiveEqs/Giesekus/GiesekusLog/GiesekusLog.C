...
Foam::tmp<Foam::volScalarField> Foam::constitutiveEqs::GiesekusLog::dotTHfun()
{
...
void Foam::constitutiveEqs::GiesekusLog::correct()
{
    ...
    (
	  ...
	  + (trhs - alpha_ * ((eigVecs_ & eigVals_ & eigVecs_.T() ) & (trhs & trhs))) / lambda_
...
Foam::tmp<Foam::volScalarField> Foam::constitutiveEqs::GiesekusLog::energyExtraTerms()
{
    return tmp<volScalarField>
    (
        new volScalarField
