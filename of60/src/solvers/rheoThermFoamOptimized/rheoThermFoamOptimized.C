...
Description
    Transient solver for compressible, laminar flow. Any GNF or viscoelastic
    model of library in constitutiveEquations can be selected. Pressure-velocity
    coupling is using the SIMPLEC algorithm.
    
    This solver is part of rheoThermTool.
