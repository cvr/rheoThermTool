...
Foam::tmp<Foam::volScalarField> Foam::constitutiveEqs::PTTlinearLog::dotTHfun()
{
...
Foam::tmp<Foam::volScalarField> Foam::constitutiveEqs::PTTlinearLog::energyExtraTerms()
{
    return tmp<volScalarField>
    (
        new volScalarField
